...
urlpatterns = [
    ...
    url(r'^Hoyrutas','web.views.obtenerTodasRutas_Hoy'),
    ...
    url(r'^UsersSiguiendos', 'web.views.obtenerUsuariosSiguiendos'),
    url(r'^UsersSeguidores', 'web.views.obtenerUsuariosSeguidores'),
    ...
    url(r'^numPeticion','web.views.misPeticiones'),    
